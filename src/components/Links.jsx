...
className=" bg-cartBg flex text-sm md:text-base items-center justify-center hover:bg-gray-300 text-black py-2 px-4 border border-gray-200 hover:border-transparent rounded w-2/3">{data.name}</a>
